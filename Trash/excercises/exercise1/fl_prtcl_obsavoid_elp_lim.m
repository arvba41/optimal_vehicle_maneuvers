function [oplsol,elps] = fl_prtcl_obsavoid_elp_lim(mdl,obst,cons,optops)
...
opti.subject_to(xpos(N+1)==Xfin);  % finish line at position x 
...
oplsol.topt = opti.debug.value(T); oplsol.tvec = linspace(0,sol.value(T),N+1);
