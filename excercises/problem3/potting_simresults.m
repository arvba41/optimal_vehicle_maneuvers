function potting_simresults(t,y,figno,parmas,inputs)
...
for ii = linspace(1,t(end),20)
    xi = interp1(t,y(:,1),ii); 
    yi = interp1(t,y(:,2),ii);
    
    yaw = interp1(t,y(:,5),ii); % yaw at time instant t
...
ylabel('$T_f$ [kNm]','Interpreter','latex'); 
xlabel('$t$ [s]','Interpreter','latex'); 
